...
{
	unsigned int width = 3840, height = 2160;								// properties of the image
...
int main()
{
	...
	spheres.emplace_back(Sphere(Vec3f(-0.5, 3.0, -10), 1,	 Vec3f(0.0, 1.0, 0.0),	1, 0.0));
	spheres.emplace_back(Sphere(Vec3f(1.0, 0.0, -10), 1,	 Vec3f(0.0, 0.0, 1.0),	1, 0.0));

	// light
	spheres.emplace_back(Sphere(Vec3f(0.0, 10.0, -10), 3, Vec3f(0.0, 0.0, 0.0),		0, 0.0, Vec3f(1)));
